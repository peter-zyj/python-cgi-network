...
#result["i"] = 0
#result["j"] = 0
lena = mpimg.imread('/var/www/html/images/lab-map-base-act2.png')
plt.imshow(lena)
...
#plt.show()
plt.savefig("/var/www/html/images/map.png",dpi=200)
...
#print '<form action="/var/www/html/Yijun/labMap/cgi-bin/labMap2.py" method="post">'
